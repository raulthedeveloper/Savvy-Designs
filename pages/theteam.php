...
<section class="home-team pt-5 pb-5">
    <h1 class="text-center secondary-headers"><?php echo $result ?  "Meet the Team" :  "connect to the Database to see your team"; ?></h1>
    <div class="container">
        <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
                     <div class="card card-style2 team-card">
                         <div class="card_img"><img class="img-fluid img-full loaded" height="400" data-original="img/"
                                 data-was-processed="true" src="../images/generic_profile_pic.jpg"
                                 alt="Team one">
                         ...
                         <a href="team_member.php?id=test"><h4 class="card-title"> </h4>
                             <span><?php echo "Team Member" ?></span></a>
                         </div>
                     </div>
                 </div>
      <?php } 
