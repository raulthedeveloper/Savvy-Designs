 ...
 if (!$result) { ?>
            <div class="row">
                <div class="col-md-6 bg-light">
                    ...
                    <button class="btn btn-success d-block m-auto">See More</button>
    ...
    while($row = mysqli_fetch_assoc($result)) {
        ...
        <div class="row">
            <div class="col-md-6 bg-light">
                ...
                <a href="pages/work-item.php?src=index&id=<?php echo $id ?>"><button class="btn btn-success d-block m-auto">See More</button></a>
...
?>
                            ...
                            <form id="contactForm" action="" method="post"><input class="form-control" type="hidden"
                                    name="Introduction" value="This email was sent from www.awebsite.com"><input
                                        ...
                                        <div class="form-group"><label for="from-email">Email</label><span
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend"><span class="input-group-text"><i
                                                    ...
                                                    class="form-control" type="text" id="from-email" name="email"
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Contact Information</h4><button type="button" class="close"
                                ...
                                <div class="form-row">
                                    <div class="col-12 col-md-6" id="message">
                                        <h2 class="h4"><i class="fa fa-envelope"></i> Contact
                                            Us<small><small class="required-input">&nbsp;(*required)</small></small>
                                        </h2>
                                        <div class="form-group"><label for="from-name">Name</label><span
                                                class="required-input">*</span>
                                            <div class="input-group">
